...
public class encarnacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encarnacion);
    ...
    private void api_key() {
        ...
        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?id=3438735&appid= ACA VA LA API KEY PERSONAL &units=metric")
                .get()
                .build();
